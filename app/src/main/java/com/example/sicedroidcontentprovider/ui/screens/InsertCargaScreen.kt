        ...
        Column(
            ...
            Card {
                Column(
                    ...
                    Text("Datos de la Materia", style = MaterialTheme.typography.titleMedium)
                    ...
                    OutlinedTextField(value = estado, onValueChange = { estado = it }, label = { Text("Estado de Materia") }, modifier = Modifier.fillMaxWidth())
                }
            }
            ...
            Card {
                Column(
                    ...
                    OutlinedTextField(value = lunes, onValueChange = { lunes = it }, label = { Text("Lunes") }, modifier = Modifier.fillMaxWidth())
                    OutlinedTextField(value = martes, onValueChange = { martes = it }, label = { Text("Martes") }, modifier = Modifier.fillMaxWidth())
                    OutlinedTextField(value = miercoles, onValueChange = { miercoles = it }, label = { Text("Miércoles") }, modifier = Modifier.fillMaxWidth())
                    OutlinedTextField(value = jueves, onValueChange = { jueves = it }, label = { Text("Jueves") }, modifier = Modifier.fillMaxWidth())
                    OutlinedTextField(value = viernes, onValueChange = { viernes = it }, label = { Text("Viernes") }, modifier = Modifier.fillMaxWidth())
                    OutlinedTextField(value = sabado, onValueChange = { sabado = it }, label = { Text("Sábado") }, modifier = Modifier.fillMaxWidth())
                }
            }
            ...
            Card {
                Column(
                    ...
                    OutlinedTextField(value = semipresencial, onValueChange = { semipresencial = it }, label = { Text("Semipresencial") }, modifier = Modifier.fillMaxWidth())
                    OutlinedTextField(value = clvOficial, onValueChange = { clvOficial = it }, label = { Text("Clave Oficial") }, modifier = Modifier.fillMaxWidth())
                }
            }
            ...
            Button(
                onClick = {
                    ...
                    viewModel.insertarCargaAcademica(context, nuevaCarga)
                ...
                Text("Guardar en Content Provider")
            }
